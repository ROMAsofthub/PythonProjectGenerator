...
# Step 2: Create a virtual environment inside the project directory
...
# Step 5: Create folders inside the project directory
...
# Step 6: Create files inside the project directory
